...
class CreatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @covers Lakshay\Converter\Standard\RIS\Creator::create
     * @covers Lakshay\Converter\Standard\RIS\Creator::getPerson
     * @covers Lakshay\Converter\Standard\RIS\Creator::getDate
     * @covers Lakshay\Converter\Standard\RIS\Creator::getType
     * @covers Lakshay\Converter\Standard\RIS\Creator::retrieve
...
ER  - '
    ...
    {
        $entry  =   new \Lakshay\Converter\Model\Entry();
        $date   =   new \Lakshay\Converter\Model\Date();
        $date
            ->setYear(1984)
            ->setMonth(1)
            ->setDay(19)
        ...
        $nextDate   =   new \Lakshay\Converter\Model\Date();
        $nextDate->setYear(1984)->setSeason('summer');
        $entry->getAccessed()->setDate($nextDate);
        $entry->getType()->setBook();
        $entries    =   new \Lakshay\Converter\Model\Entries();
        $entries->setEntry($entry);

        $noYear =   new \Lakshay\Converter\Model\Entry();
        $noYear->getType()->setBook();
        $noYear->setTitle('No Year');
        $noYearDate =   new \Lakshay\Converter\Model\Date();
...
ER  - ', $this->object->retrieve());
    ...
    {
        $this->assertFalse($this->object->create(new \Lakshay\Converter\Model\Entries()));
