...
class ParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @covers Lakshay\Converter\Standard\RIS\Parser::parse
     * @covers Lakshay\Converter\Standard\RIS\Parser::getType
     * @covers Lakshay\Converter\Standard\RIS\Parser::getDate
     * @covers Lakshay\Converter\Standard\RIS\Parser::getPerson
     * @covers Lakshay\Converter\Standard\RIS\Parser::retrieve
        ...
        foreach ($entries as $entry) {
            ...
            if (isset($data['editors']) == true) {
                ...
                foreach ($entry->getEditor() as $editor) {
                    /** @var $editor \Lakshay\Converter\Model\Person */
