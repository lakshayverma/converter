...
class ParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @covers Lakshay\Converter\Standard\BibTeX\Parser::parse
     * @covers Lakshay\Converter\Standard\BibTeX\Parser::extract
     * @covers Lakshay\Converter\Standard\BibTeX\Parser::retrieve
     * @covers Lakshay\Converter\Standard\BibTeX\Parser::create
     * @covers Lakshay\Converter\Standard\BibTeX\Parser::createPersons
    ...
    public function testParseOne($bibTeX, $lastName, $title, $type, $year)
    {
        ...
        $this->assertInstanceOf('\Lakshay\Converter\Model\Entry', $entries[0]);
        /** @var $entry \Lakshay\Converter\Model\Entry */
        $entry      =   $entries[0];

        foreach ($entry->getAuthor() as $author) {
            /** @var $author \Lakshay\Converter\Model\Person */
            $this->assertInstanceOf('\Lakshay\Converter\Model\Person', $author);
        ...
        foreach ($entry->getIssued() as $issued) {
            /** @var $issued \Lakshay\Converter\Model\Date */
  ...
  volume  = 4
    ...
    public function testParseMultiple($bibTeX, array $titles, array $types)
    {
        $this->assertTrue($this->object->parse($bibTeX));
        $entries    =   $this->object->retrieve();
        $this->assertInstanceOf('\Lakshay\Converter\Model\Entries', $entries);

        $position   =   0;
        foreach ($entries as $entry) {
            /** @var $entry \Lakshay\Converter\Model\Entry */
            $this->assertInstanceOf('\Lakshay\Converter\Model\Entry', $entry);
